...
@can('contact_us_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            ...
            @include('csvImport.modal', ['model' => 'ContactUs', 'route' => 'admin.contact-uss.parseCsvImport'])
        </div>
    </div>
@endcan
<div class="card">
            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-ContactUs">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.contactUs.fields.degination') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
                    ...
                    @foreach($contactUss as $key => $contactUs)
                        <tr data-entry-id="{{ $contactUs->id }}">
                            ...
                            <td>
                                ...
                                @can('contact_us_edit')
                                    <a class="btn btn-xs btn-info" href="{{ route('admin.contact-uss.edit', $contactUs->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan
