    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.seos.update", [$seo->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('meta_tags') ? 'is-invalid' : '' }}" type="text" name="meta_tags" id="meta_tags" value="{{ old('meta_tags', $seo->meta_tags) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" type="text" name="description" id="description" value="{{ old('description', $seo->description) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('seo_title') ? 'is-invalid' : '' }}" type="text" name="seo_title" id="seo_title" value="{{ old('seo_title', $seo->seo_title) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('og_type') ? 'is-invalid' : '' }}" type="text" name="og_type" id="og_type" value="{{ old('og_type', $seo->og_type) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('canonical_url') ? 'is-invalid' : '' }}" type="text" name="canonical_url" id="canonical_url" value="{{ old('canonical_url', $seo->canonical_url) }}">
