    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.ads.update", [$ad->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('type') ? 'is-invalid' : '' }}" name="type" id="type">
                    ...
                    @foreach(App\Models\Ad::TYPE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('type', $ad->type) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('type'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('start_date') ? 'is-invalid' : '' }}" type="text" name="start_date" id="start_date" value="{{ old('start_date', $ad->start_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('end_date') ? 'is-invalid' : '' }}" type="text" name="end_date" id="end_date" value="{{ old('end_date', $ad->end_date) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" name="status" id="status">
                    ...
                    @foreach(App\Models\Ad::STATUS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('status', $ad->status) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('impressions') ? 'is-invalid' : '' }}" type="text" name="impressions" id="impressions" value="{{ old('impressions', $ad->impressions) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('clicks') ? 'is-invalid' : '' }}" type="text" name="clicks" id="clicks" value="{{ old('clicks', $ad->clicks) }}">
